...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        milkCheck.setOnClickListener(v -> onCheckboxClicked(v));
        sugarCheck.setOnClickListener(v -> onCheckboxClicked(v));
        lemonCheck.setOnClickListener(v -> onCheckboxClicked(v));
    }
    ...
    public void onCheckboxClicked(View view) {
        ...
        for (CharSequence goodies : TeaGoodies) teaTime.append(goodies).append((", "));
